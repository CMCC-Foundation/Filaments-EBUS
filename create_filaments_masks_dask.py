...
"""
Computes the daily time series of binary masks identifying filaments from clustering (n_time, lon, lat).
"""
...
if __name__ == '__main__':
    ...
    if not os.path.exists('outputs/filament_masks/'):
        print('filament_masks folder is missing. Creating it.')
        os.makedirs('outputs/filament_masks/')
    ...
    for region_label, boxes in regions.items():
        ...
        streamers_cluster = find_filament_cluster(train_data, labels)
        ...
        for box in tqdm(boxes):
            ...
            masks.to_netcdf(f'outputs/filament_masks/box_{box_code}.nc')
